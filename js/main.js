MainCustomLogic = {
    clockComponent: React.createClass({
        propTypes: {
            dTime: React.PropTypes.instanceOf(Date),
        },
        ...
        render: function() {
            return React.DOM.div(null, 
                React.DOM.span(null, this.props.dTime.toLocaleTimeString())
            );
        }
    }),
    mainMenuComponent: React.createClass({
        propTypes: {
